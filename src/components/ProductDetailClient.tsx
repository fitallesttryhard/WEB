...
export default function ProductDetailClient({ product, initialRelatedProducts }: ProductDetailClientProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-16 mb-12 lg:mb-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 mb-4">
              <h2 className="text-3xl md:text-4xl font-black text-gray-900">{product.name}</h2>
        ...
        {initialRelatedProducts.length > 0 && (
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {initialRelatedProducts.map((relProd) => (
                <a 
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    <span className="text-[11px] text-gray-400 font-bold uppercase tracking-widest mb-1.5">{relProd.categories?.name || 'Sản phẩm'}</span>
