...
export const FIT_TENANT_ID = '00000000-0000-0000-0000-000000000001';
...
export async function getProjects(tenantId: string = FIT_TENANT_ID): Promise<ProjectItem[]> {
  try {
...
export async function saveProject(project: Partial<ProjectItem>, tenantId: string = FIT_TENANT_ID): Promise<ProjectItem | null> {
  try {
